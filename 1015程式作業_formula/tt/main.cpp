...
class Mission {
    ...
    /*void Mission2new() {
         ...
         while ( num > 1 ){
            ...
            strcpy( tempnewpost->str, temppost->str ) ;
            tempnewpost->next = new Read ;
            tempnewpost->next->next = NULL ;
            temppost = post ;
            tempnewpost = tempnewpost->next ;
            num-- ;
            tempnum = num ;
         }
         ...
         tempnewpost = newpost ;
         while ( tempnewpost != NULL ){
            cout << "herher\n" ;
            cout << tempnewpost->str ;
            tempnewpost = tempnewpost->next ;
         }
